...
def init_flask_restful_routes(app):
    ...
    from server.api.message_apis import ProjectsMessageAll, HasNewMessages, GetAllMessages, MessagesAPI, PMMessageAPI
    ...
    api.add_resource(PMMessageAPI,                  '/api/v1/messages/send-pm-message/project/<int:project_id>')
